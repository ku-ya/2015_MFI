...
\usepackage[backref=true,breaklinks=true,hidelinks,colorlinks=true,bookmarks=false,citecolor=green]{hyperref}
...
\author{Kuya Takami$^{1}$*, Tomonari Furukawa$^{1}$ and Makoto Kumon$^{2}$% <-this % stops a space
